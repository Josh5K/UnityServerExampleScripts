...
public class ServerSend
{
    ...
    public static void CreateItemSpawner(int _client, int _spawnerID, Vector3 _position, bool _hasItem)
    {
    ...
    public static void ItemPickedUp(int _spawnerID, int _player)
    {
    ...
    public static void GameStarted(int _sceneID)
    {
        using (Packet _packet = new Packet((int)ServerPackets.gameStarted))
        {
